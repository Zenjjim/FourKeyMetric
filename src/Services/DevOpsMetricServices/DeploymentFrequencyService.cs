...
{
    public List<DeploymentBucket> GetBuckets(int intervalMonths,  List<Deployment> deployments)
    {
    ...
    public async Task<DeploymentFrequencyModel> Calculate(int intervalMonths, string? organization, string? project, string? repository)
    {
        ...
        return CalculateBuckets(intervalMonths, deploymentList);
    }

    public DeploymentFrequencyModel CalculateBuckets(int intervalMonths, List<Deployment> deploymentList)
    {
        var deploymentBucket = GetBuckets(intervalMonths, deploymentList);
